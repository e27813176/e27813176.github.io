demo.LevelMap.medalBoard = {
    create:function(){
        ...
        this.MedalBtn =  game.add.sprite(150, 200, 'Medal','MedalBtn.png');
        this.MedalBtn.alpha = 1;
        this.MedalBtn.anchor.setTo(0.5);

        this.MedalBtnHover =  game.add.sprite(150, 200, 'Medal','MedalBtnOver.png');
        this.MedalBtnHover.anchor.setTo(0.5);
        this.setTween(this.MedalBtnHover);
        this.setMedalBtn();
        
        this.ConfirmBtnHover = game.add.sprite(0, 100, 'Medal','ConFirmBtnHover.png');
        this.ConfirmBtnArea = game.add.sprite(1082, 615, 'Medal','ConFirmBtnHoverArea.png');
        this.setConfirmBtn();
