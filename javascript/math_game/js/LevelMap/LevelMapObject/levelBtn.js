demo.LevelMap.levelBtn = {
    create:function(){
        this.HomeBtnHoverArea =  game.add.sprite(game.world.centerX, 630, 'LevelBtn','BtnHover.png');
        this.HomeBtnHoverArea.anchor.setTo(0.5); 
        this.HomeBtnHoverArea.scale.setTo(1.5);
        this.HomeBtnHoverArea.alpha = 0; 
        
        this.HomeBtnHover = game.add.sprite(0, 100, 'LevelBtn','HomeBtnHover.png');
        
        this.setTween(this.HomeBtnHover);
        this.setLevelBtn( this.HomeBtnHoverArea ,this.HomeBtnHover,'GameBootPage');
                
        //TutorialBtn---------------------------------------------------------------------------
        this.TutorialBtn = game.add.sprite(55, 270, 'LevelBtn','TutorialBtn.png');
        
        this.TutorialBtnHover = game.add.sprite(55, 270, 'LevelBtn','TutorialBtnHover.png');

        this.setTween(this.TutorialBtnHover);
        this.setLevelBtn( this.TutorialBtn ,this.TutorialBtnHover,'Tutorial');
        //AxPageBtn---------------------------------------------------------------------------
        this.FoxAxBtnHoverArea =  game.add.sprite(270, 350, 'LevelBtn','BtnHover.png');
        this.FoxAxBtnHoverArea.alpha = 0; 

        this.FoxAxBtnHover = game.add.sprite(0, 100, 'LevelBtn','AxPageBtnHover.png');
        
        this.setTween(this.FoxAxBtnHover);
        this.setLevelBtn( this.FoxAxBtnHoverArea,this.FoxAxBtnHover,'BootAxPage');
        //LoggingPageBtn----------------------------------------------------------------------
        this.FoxLoggingBtn = game.add.sprite(0, 100, 'LevelBtn','FoxLoggingBtn.png');
        //FoxLoggingBtn.alpha = 0; 
        if( LevelState.AxPageComplete == false || LevelState.FoxLoggingBtnShowUp == false ){
            this.FoxLoggingBtn.alpha = 0;
        }

        this.FoxLoggingBtnHover = game.add.sprite(0, 100, 'LevelBtn','FoxLoggingBtnHover.png');
        
        this.FoxLoggingBtnHoverArea =  game.add.sprite(500, 240, 'LevelBtn','BtnHover.png');
        ...
        //CatchBugPageBtn----------------------------------------------------------------------
        this.CatchBugPageBtn = game.add.sprite(0, 100, 'LevelBtn','CatchBugBtn.png');
        if( LevelState.LoggingPageComplete == false || LevelState.FoxCatchBugPageBtnShowUp == false ){
            this.CatchBugPageBtn.alpha = 0;
        }        

        this.CatchBugPageBtnHover = game.add.sprite(0, 100, 'LevelBtn','CatchBugBtnHover.png');
        
        this.CatchBugPageBtnHoverArea =  game.add.sprite(860, 290, 'LevelBtn','BtnHover.png');
        ...
        //FishingPageBtn-----------------------------------------------------------------------
        this.FoxFishingBtn = game.add.sprite(0, 100, 'LevelBtn','FoxFishingBtn.png'); 
        ...
        this.FoxFishingBtnHover = game.add.sprite(0, 100, 'LevelBtn','FoxFishingBtnHover.png'); 
        
        this.FoxFishingBtnHoverArea =  game.add.sprite(1190, 510, 'LevelBtn','BtnHover.png');
