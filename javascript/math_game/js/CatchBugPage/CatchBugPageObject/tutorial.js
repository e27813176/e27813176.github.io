demo.CatchBugPage.tutorial = {
    create:function(){
        ...
        this.askBoard = game.add.sprite(0,100,'TutorialText','TutorialAsk.png');
        this.askBoard.alpha = 0;              
        
        this.NoBtn = game.add.sprite(922,504,'TutorialText','TutorialBtn.png');
        this.NoBtn.alpha = 0;
        this.NoBtn.events.onInputDown.add(this.skip, this);

        this.YesBtn = game.add.sprite(867,504,'TutorialText','TutorialBtn.png');
        this.YesBtn.alpha = 0;
