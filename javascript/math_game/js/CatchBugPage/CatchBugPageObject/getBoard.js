demo.CatchBugPage.getBoard = {
    create:function(){
        this.Board = game.add.sprite(800,500,'Board','Board.png');
        this.Board.anchor.setTo(0.5);
        this.Board.alpha = 0;
        
        this.GoldenBugBox = game.add.sprite(800,500,'Board','GoldenBugBox.png');
        this.GoldenBugBox.anchor.setTo(0.5);
        this.GoldenBugBox.alpha = 0;
        
        this.IceBugBox = game.add.sprite(800,500,'Board','IceBugBox.png');
        this.IceBugBox.anchor.setTo(0.5);
        this.IceBugBox.alpha = 0;
        
        this.FireBugBox = game.add.sprite(800,500,'Board','FireBugBox.png');
        this.FireBugBox.anchor.setTo(0.5);
        this.FireBugBox.alpha = 0;        
        
        this.FinishBtn = game.add.sprite(centerX+58,611,'Board','BtnArea.png');
        this.FinishBtn.anchor.setTo(0.5);
        this.FinishBtn.alpha = 0;
        this.FinishBtn.events.onInputDown.add(GetBugBoardFinishBtnDown, this);
        
        this.ContinueBtn = game.add.sprite(centerX-58,611,'Board','BtnArea.png');
