demo.FishingPage.createFish = function(){
    this.OrangeFish = game.add.sprite(0,100,'Fish');
    this.OrangeFish.alpha = 0;
    this.OrangeFishStop = game.add.sprite(0,100,'Fish');
    ...
    this.FireFishStopFire = game.add.sprite(0,100,'Fish002');
    this.FireFishStopFire.alpha = 0; 
        
    this.FireFishStop = game.add.sprite(0,100,'Fish002');
